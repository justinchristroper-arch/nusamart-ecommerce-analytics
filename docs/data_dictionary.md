...
| is_analysis_month | BOOLEAN | `TRUE` jika tanggal ini masuk bulan yang datanya lengkap (2017-01 s/d 2018-07) |

> **Jendela analisis.** Bulan di kedua ujung dataset datanya tidak lengkap: 2016-09 (1 order delivered), 2016-10 (265), 2016-11 (tidak ada order sama sekali), 2016-12 (1), 2018-08 (order harian menyusut tajam setelah tanggal 21 karena pengumpulan data berakhir), serta 2018-09 dan 2018-10 (hanya 20 order, nol delivered). Karena itu seluruh analisis memakai jendela **2017-01 s/d 2018-07** lewat filter `dim_date.is_analysis_month = TRUE`. Yang dikecualikan **6.618 dari 96.478 order delivered (6,86%)**. Aturan kelengkapan bulan — termasuk cek harian untuk bulan terakhir — dan dasar angkanya ada di `notebooks/01_data_cleaning.ipynb` bagian 6 dan 11.
